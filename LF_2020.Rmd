...
labourGO_up = topGO_wrapper(geneScores = GOscores.labour_up,
                         ...
                         p = 0.01)
#save results
GO_treeplots(labourGO_up, path = "/home/benjamin/Dropbox/Ben PhD/PhD Docs/THESIS/data_chapter_3/figures/experiment1_labour_up_GO_plots.png")
...
#save results
GO_treeplots(labourGO_down, path = "/home/benjamin/Dropbox/Ben PhD/PhD Docs/THESIS/data_chapter_3/figures/experiment1_labour_down_GO_plots.png")
...
gg_exp2_pairwise_DEGs_all = ggarrange(DEGplot_lfc0_finalrank, DEGplot_lfc1.5_finalrank, DEGplot_lfc0_origrank, DEGplot_lfc1.5_origrank,
...
offNestDEGs_forGO$OffNestFinal %>% subset(padj<0.05 & log2FoldChange>0)
...
GO_treeplots(foragingGO_up, path = "/home/benjamin/Dropbox/Ben PhD/PhD Docs/THESIS/data_chapter_3/figures/experiment2_foraging_up_GO_plots.png")
...
#save plots and table
GO_treeplots(foragingGO_down, path = "/home/benjamin/Dropbox/Ben PhD/PhD Docs/THESIS/data_chapter_3/figures/experiment2_foraging_down_GO_plots.png")
...
#save results
GO_treeplots(darkturquoiseGO, path = "/home/benjamin/Dropbox/Ben PhD/PhD Docs/THESIS/data_chapter_3/figures/experiment2_darkturquoise_GO_plots.png")
...
GO_treeplots(greenGO, path = "/home/benjamin/Dropbox/Ben PhD/PhD Docs/THESIS/data_chapter_3/figures/experiment2_green_GO_plots.png")
...
GO_up_exp2_rank_full = topGO_wrapper(geneScores = GOscores_up_exp2_rank,
                                  ...
                                  p = 0.01) 
#save results
GO_treeplots(GO_up_exp2_rank_full, path = "/home/benjamin/Dropbox/Ben PhD/PhD Docs/THESIS/data_chapter_3/figures/experiment2_rank_up_GO_plots.png")
...
GO_down_exp2_rank_full = topGO_wrapper(geneScores = GOscores_down_exp2_rank,
                                    ...
                                    p = 0.01)
#save results
GO_treeplots(GO_down_exp2_rank_full, path = "/home/benjamin/Dropbox/Ben PhD/PhD Docs/THESIS/data_chapter_3/figures/experiment2_rank_down_GO_plots.png")
...
labs = matrix(nrow = length(upChars), 
              ncol = length(upChars), 
              dimnames = list(upChars,upChars))
...
for(i in 1:nrow(contrasts)){
  ...
  labs[contrasts[i,1],contrasts[i,2]] = label
  labs[contrasts[i,2],contrasts[i,1]] = label
...
gg_exp2_upDEG_overlaps = ggplot(data = comps_plot, aes(x=Var1, y=Var2, fill=value)) + 
  scale_x_discrete(labels = upLabels) +
  scale_y_discrete(labels = upLabels) +
  geom_tile(color = "black") +
  geom_text(aes(label=value),
            nudge_y = 0.05, fontface = 2) +
  geom_text(aes(label=na.omit(c(labs))),
            nudge_y = -0.15, size = 3) +
  scale_fill_gradientn(colours = colorRampPalette(rev(c("#FFFFFF",brewer.pal(n = 9, name = "Reds")[1:5])),bias=6)(20),
                       breaks = c(0.0,0.05,1),
                       expand = c(0,0),
...
labs = matrix(nrow = length(upGOChars), 
              ncol = length(upGOChars), 
              dimnames = list(upGOChars,upGOChars))
...
labs = matrix(nrow = length(downChars), 
              ncol = length(downChars), 
              dimnames = list(downChars,downChars))
...
gg_exp2_downDEG_overlaps = ggplot(data = comps_plot, aes(x=Var1, y=Var2, fill=value)) + 
  ...
  geom_text(aes(label=na.omit(c(labs))),
            nudge_y = -0.15, size = 3) +
  scale_x_discrete(labels = downLabels) +
  scale_y_discrete(labels = downLabels) +
  scale_fill_gradientn(colours = colorRampPalette(rev(c("#FFFFFF",brewer.pal(n = 9, name = "Reds")[1:5])),bias=6)(20),
                       breaks = c(0.0,0.05,1),
                       expand = c(0,0),
                       limits = c(0,1),
...
labs = matrix(nrow = length(downGOChars), 
               ncol = length(downGOChars), 
               dimnames = list(downGOChars,downGOChars))
