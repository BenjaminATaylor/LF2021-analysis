...
```{r generate_genelists_for_comparison}
...
GO_darkturquoise = darkturquoiseGO
```

Then let's compare all gene lists that are putatively direct fitness-biased:

```{r genelist_directfitness_comparisons}
upChars = c("genes_up_exp1_labour",
           "genes_up_exp2_rank",
           "genes_up_exp2_antiforaging",
           "genes_up_Pdom_caste_LF")

gene_comparisons_up = list(genes_up_exp1_labour,
                           genes_up_exp2_rank,
                           genes_up_exp2_antiforaging,
                           genes_up_SVM_LF,
                           genes_up_Pdom_caste_LF)

gene_comparisons_down = list(genes_down_exp1_labour,
...
```{r genelist_indirectfitness_comparisons}
