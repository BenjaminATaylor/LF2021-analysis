...
phylo_neutral = subset(phylostrata, !(qseqid %in% c(genes_down_exp2_antiforaging, genes_up_exp2_antiforaging)))$bin
...
stratacontingency_ancient = cbind(stratacontingency[,1],rowSums(stratacontingency[,1:3]))
#negatively-correlated genes are not more likely to be ancient
