...
exclude = c("SolF5", # Phenotypic outlier
            "Sol34","SocF14") # Gene expression outliers
...
```
Given that there's a significant overlap in GO terms, might there also be an overlap in terms of (orthologous) genes?
